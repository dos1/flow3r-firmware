...
static void ST_loadUnloadGraphics(load_callback_t callback)
{
    ...
    for (i=0;i<10;i++)
    {
	DEH_snprintf(namebuf, 16, "STTNUM%d", i);
        callback(namebuf, &tallnum[i]);

	DEH_snprintf(namebuf, 16, "STYSNUM%d", i);
    ...
    for (i=0;i<NUMCARDS;i++)
    {
    	DEH_snprintf(namebuf, 16, "STKEYS%d", i);
    ...
    for (i=0; i<6; i++)
    {
    	DEH_snprintf(namebuf, 16, "STGNUM%d", i+2);
    ...
    DEH_snprintf(namebuf, 16, "STFB%d", consoleplayer);
	...
	{
	    DEH_snprintf(namebuf, 16, "STFST%d%d", i, j);
            callback(namebuf, &faces[facenum]);
            ++facenum;
	}
	DEH_snprintf(namebuf, 16, "STFTR%d0", i);	// turn right
        callback(namebuf, &faces[facenum]);
        ++facenum;
	DEH_snprintf(namebuf, 16, "STFTL%d0", i);	// turn left
        callback(namebuf, &faces[facenum]);
        ++facenum;
	DEH_snprintf(namebuf, 16, "STFOUCH%d", i);	// ouch!
        callback(namebuf, &faces[facenum]);
        ++facenum;
	DEH_snprintf(namebuf, 16, "STFEVL%d", i);	// evil grin ;)
        callback(namebuf, &faces[facenum]);
        ++facenum;
	DEH_snprintf(namebuf, 16, "STFKILL%d", i);	// pissed off
        callback(namebuf, &faces[facenum]);
        ++facenum;
    }
