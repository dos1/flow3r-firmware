...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mp_channel_set_foreground_obj, mp_channel_set_foreground);

STATIC mp_obj_t mp_channel_get_background_mute_override(mp_obj_t index) {
    bool ret = bl00mbox_channel_get_background_mute_override(mp_obj_get_int(index));
    return mp_obj_new_bool(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mp_channel_get_background_mute_override_obj, mp_channel_get_background_mute_override);

STATIC mp_obj_t mp_channel_set_background_mute_override(mp_obj_t index, mp_obj_t enable) {
    bool ret = bl00mbox_channel_set_background_mute_override(mp_obj_get_int(index), mp_obj_is_true(enable));
    return mp_obj_new_bool(ret);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mp_channel_set_background_mute_override_obj, mp_channel_set_background_mute_override);
...
STATIC const mp_map_elem_t bl00mbox_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_channel_set_foreground), MP_ROM_PTR(&mp_channel_set_foreground_obj) },
    { MP_ROM_QSTR(MP_QSTR_channel_get_background_mute_override), MP_ROM_PTR(&mp_channel_get_background_mute_override_obj) },
    { MP_ROM_QSTR(MP_QSTR_channel_set_background_mute_override), MP_ROM_PTR(&mp_channel_set_background_mute_override_obj) },
