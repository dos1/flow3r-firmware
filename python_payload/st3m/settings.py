...
num_leds_brightness = StringTunable("LED Brightness", "system.appearance.leds_brightness", 70)

num_leds_speed = StringTunable("LED Speed", "system.appearance.leds_speed", 235)
onoff_leds_random_menu = OnOffTunable("Random Menu LEDs", "system.appearance.leds_random_menu", False)
