...
class Jack(Protocol):
	...
	def active(self) -> bool:
		"""
		Returns true if this jack is currently enabled for badgelink, false if
	...
	def tip(self) -> Pin:
		"""
		Return the GPIO Pin object for the tip of this jack.
	...
	def ring(self) -> Pin:
		"""
		Return the GPIO Pin object for the ring of this jack.
